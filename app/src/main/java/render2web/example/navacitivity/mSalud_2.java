...
import com.example.javiergomez.msalud.R;


public class mSalud_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_m_salud_2);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View view) {
                ...
                //Intent intent = new Intent(view.getContext(), render3web.example.navacivity.mSalud_3.class);
    ...
    private void enviardatos (){
        ...
        Intent intent = new Intent(mSalud_2.this, render3web.example.navacivity.mSalud_3.class);
